...
Default, RealChute, RealHeat, RealAntennas, RealFuels. Probes first. Not Realism Overhaul. We
...
Never overwrite `first-mystery-goo.png`. Os stills from `/home/os/ksp_screens`
are copied here under honest slugs when the photo is the right event.

| Date | Story | Sci | Shot |
|---|---|---|---|
| 2026-08-26 | [Everybody left](everybody-left.md) — we lit a RealFuels rocket, clocked out, and fitted a review to a window | 2.29 → 2.29 | [in the dark](../../screenshots/everybody-left.png) |
