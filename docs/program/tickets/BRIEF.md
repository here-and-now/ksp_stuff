...
Eleanor (Director of Constellation Operations) is disk only: `python main.py
...
**VAB helpers (Os 2026-08-25 / T-481 / T-496 / T-499):** Gus does not default to hand-writing
...
clearance** (T-500). C-534 loft is **no-HS** (C-504 shelf) — a helper
that writes a loft hang must autostrut Heaviest/rigid + stage-engine
...
GameData. Pad flies C-534 — do not idle for helpers.
