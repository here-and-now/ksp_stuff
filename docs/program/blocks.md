...
``left_pad``, command **25°** from vertical heading **270** inland
...
**10-17-18Z** 38/−10 past horizon — re-point if flipped, do not skip on ``engaged``; **10-33-44Z** 353/26 missed 90° — write ``target_direction``).
Do **not** engage at ~90. Not
**090**. Hold AP through burnout. No chute
