...
splash 230 m/s). Leftover LF suicide near Water latches until vz
cut (22-57-36Z TTI 19 recut lofted leftover, splash 119 m/s).
Stayputnik still has no torque after cutoff. Starts the
...
LF suicide near Water (latch until vz cut). **No** east slew — do not
