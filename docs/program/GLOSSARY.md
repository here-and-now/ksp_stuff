...
| **world model** | `docs/program/world-model.md`. Gene chairs. Facts / meaning / horizon / story. |
| **niche** | `docs/crew/niche/<slug>.md`. Private until conference. |
| **ask:** | Ground question for another desk. Parent files it; next spawn answers. |
...
| **tech-unlock** | Catalog CLI (kRPC). 0.6 has no purchase RPC — aborts. Paid node: Mortimer edits the save then `python main.py load persistent`. |
