...
wall. Frozen MET / Flight Results unpauses physics and waits
``sit=landed`` (11-23-25Z banked there). Do not ``go_space_center``
while ``flying recoverable=no``. Post-dismiss
