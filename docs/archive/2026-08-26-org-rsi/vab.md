...
notes: Disk re-verified (no PART rewrite). Hang stays **t7-wheel-pbc**
  ...
  the same 4.375 m as the 88.8 km proof. Next loft. Alts via
  craft clone/liquid/heatshield: T-428 proc-hs 1.25 disc Ablative 80;
  T-430 proc-cone Nylon 50m (do not Hangar this sit); T-431
  proc-oxstat 4×0.35 EC/s; T-433 proc-nose aero not silk. Not
  girderless lite / dv5 1.427×0.5 / 4t 1.25×0.65. T-408 4× OX-STAT
  on tank 2 vs t7 3×Z-100 EC=0 MET 440 and Goo 641×0.18. T-409
  proceduralNoseCone (stability, Stayputnik has no top node — OKTO).
  Do not Hangar T-409 as silk.
